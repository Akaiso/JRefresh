...
public class Scope {
    ...
    //method main creagtes and initializes local variavle x
    ...
    public static void main(String[] args) {
        ...
        useLocalVariable(); //useLocalVariable reinitialixes local z
        useField(); //class Scope's field x retains its value

        System.out.printf("%nlocal x in main is %d%n", x);
    }

    //create and initialixe local variable x during each call
