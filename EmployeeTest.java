...
public class EmployeeTest {
    public static void main(String[] args){
        ...
        System.out.printf("Employees fbefore instantiation: %d%n", Employee.getCount());
        ...
        System.out.printf("%nEmployee 2: %s %s%nEmployee 2: %s %s%n", e1.getFirstName(), e1.getLastName(), e2.getFirstName(), e2.getLastName());
    }
}
